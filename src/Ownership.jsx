...
export default function Ownership({ back }) {
  return <>
    ...
    <div className="ownership-details">
      ...
      <article><span className="number">04</span><div><h2>An honest starting point.</h2><p>This alpha creates projects, imports supported Git bundles, edits text, previews a static page, saves versions, restores clean projects, and exports history. It can run an installed Codex CLI in a separate project copy and bring back a reviewed proposal. Request files are also available as portable handoffs.</p><p>Get Unforge from unforge.app. GitHub is a public copy of the source. Your apps clone, check, merge, and publish from this Mac. Hosted database backups and team chat are not this alpha.</p></div></article>
    </div>
