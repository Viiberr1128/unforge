...
final class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate, WKNavigationDelegate, WKUIDelegate, WKDownloadDelegate, WKScriptMessageHandler {
    ...
    @objc func about() {
        NSApp.orderFrontStandardAboutPanel(options: [.applicationName: "Unforge", .applicationVersion: Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as? String ?? "0.3.0", .credits: NSAttributedString(string: "Built for humans. Operated by AI. Owned by you.\nLocal workspace · MIT open source\nYour projects stay outside the app bundle.")])
    }
